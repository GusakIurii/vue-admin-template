<template>
  ...
  <div style="padding:30px;">
    <el-alert :closable="false" title="Інвертер №2" />
...
<script>
import { default as dataInv } from "@/components/Inverter/data-inv-02"
import { computed } from '@/computed/computedInv02.js'
...
export default {
  ...
  data() {
    ...
    if (this.connection === null) {
      ...
      this.connection = new WebSocket("wss://admin.spe.pp.ua/InvRead_1796536722")
