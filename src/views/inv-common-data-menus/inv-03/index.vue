<template>
  ...
  <div style="padding:30px;">
    <el-alert :closable="false" title="Інвертер №3" />
       <h4 style="margin-top:20px;">Загальні дані</h4>
...
<script>
import { default as dataInv } from "@/components/Inverter/data-inv-03"
import { computed } from '@/computed/computedInv03.js'
...
export default {
  ...
  data() {
    ...
    if (this.connection === null) {
      ...
      this.connection = new WebSocket("wss://admin.spe.pp.ua/InvRead_1796437366")
